...
namespace PicturePerfectAPI.Data
{
    public class ApplicationDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Post>().HasMany(p => p.Fotos).WithOne().IsRequired().HasForeignKey("PostId");
            builder.Entity<Post>().Property(p => p.Categories).IsRequired();
            ...
            builder.Entity<Gebruiker>().HasMany(g => g.Posts).WithOne().IsRequired();
